...
<script src="<?php echo ASSETS; ?>plugins/bower_components/sidebar-nav/dist/sidebar-nav.min.js"></script>
<!--slimscroll JavaScript -->
<script src="<?php echo ASSETS; ?>js/jquery.slimscroll.js"></script>
<!--Wave Effects -->
<script src="<?php echo ASSETS; ?>js/waves.js"></script>
<!--Counter js -->
<script src="<?php echo ASSETS; ?>plugins/bower_components/waypoints/lib/jquery.waypoints.js"></script>
